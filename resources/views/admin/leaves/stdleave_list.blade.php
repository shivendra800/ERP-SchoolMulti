                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class=" card-header bg-navy disabled color-palette">
                            ...
                            <a href="{{url('/')}}/Stdapprovel-list" class="btn btn-danger float-right">Approve list</a>
                            <a href="{{url('/')}}/Stdcancel-list" class="btn btn-danger float-right mr-3 ">Cancel list</a>
                                ...
                                <tbody>
                                    @foreach ($stdleavelist as $index => $getstuddent)
                                        <tr>
                                            ...
                                            <td>{{ $getstuddent['leave_status'] }}</td>
                                            <form action="{{url('/')}}/admin-change-leavestatus/{{ $getstuddent['id'] }}" method="post">
                                                @csrf
                                                <td>
