...
@section('title', 'Student Mark Entry')
...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Student Mark Entry</li>
											...
											<form method="post" action="{{ route('marks.entry.store') }}">
												...
												<div class="row">
													...
													<div class="col-md-3">
														...
														<div class="form-group">
															<h5>Total Marks <span class="text-danger"> </span></h5>
															<div class="controls">
																<input name="totalsub_marks" id="totalsub_marks" required="" class="form-control"/>
															</div>
														</div>
													...
													<div class="col-md-3">
														...
														<div class="form-group">
															...
															<div class="controls">
																<input name="passing_marks" id="passing_marks" required="" class="form-control"/>
															</div>
														</div>
    ...
    <script type="text/javascript">
        $(document).on('click', '#search', function() {
            ...
            $.ajax({
                url: "{{ route('student.marks.getstudentsdata') }}",
                type: "GET",
                data: {
                    'year_id': year_id,
                    'class_id': class_id,
