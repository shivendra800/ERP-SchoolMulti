 ...
 .content .card{
    ...
    <div class="content">
       ...
       <!--for one month -->
            ...
            <div class="card one">
            <div class="top">
                <div class="title">1 Month Plan</div>
                <div class="price-sec">
                <span class="dollar">Plan</span>
            ...
            <div class="details">
                ...
                <form action="{{url('/')}}/save-subs-one/{{$admindata['id']}}" method="post">
                    @csrf
                <div class="one">
                <span>Total  </span>
                
                
                    <input type="text" name="total_price" id="total_price_id" value="" readonly class="btn btn-secondary">Rs
                    <input type="hidden" id="plan_id" value="1" name="plan">
        ...
        {{-- /<form action=""> --}}
            ...
            <div class="details">
                ...
                <form action="{{url('/')}}/save-subs-two/{{$admindata['id']}}" method="post">
                    @csrf
                    <div class="one">
                    <span>Total  </span>
                    <input type="text" name="total_price" id="total_price_id2" value="" readonly class="btn btn-secondary">Rs
        ...
        {{-- <form action=""> --}}
            ...
            <div class="details">
                ...
                <form action="{{url('/')}}/save-subs-three/{{$admindata['id']}}" method="post">
                    @csrf
                    <div class="one">
                    <span>Total Amount </span>
                    <input type="text" name="total_price" id="total_price_id3" value="" readonly class="btn btn-secondary">Rs
