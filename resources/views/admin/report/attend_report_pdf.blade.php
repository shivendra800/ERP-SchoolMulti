...
<table id="customers">
  <tr>
   ...
   <img src="{{ public_path() . $image_path }}" width="200" height="100">
     ...
     <td><h2>{{ $allData['0']['getschooldata']['getschooldat']['school_name'] }} </h2>
 {{-- <p>School Address</p> --}}
 ...
 <br> <br>
 <strong>Employee Name : </strong> {{ $allData['0']['getstaff']['name'] }}, <strong> ID No : </strong>{{ $allData['0']['getstaff']['staff_member_id'] }}, <strong> Month : </strong> {{ $month }}
 <br> <br>
<table id="customers">
