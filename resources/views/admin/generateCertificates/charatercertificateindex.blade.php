...
@section('title', 'Student Character/Transfer Certificate')
@section('content')
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Student Character/Transfer Certificate</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ url('/') }}/Dashboard">Home</a></li>
                    <li class="breadcrumb-item active">Student Character/Transfer Certificate</li>
                                        ...
                                        <tr>
                                            ...
                                            <td> {{ $value['student']['s_name'] }}</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{url('/')}}/Character-Certificate/{{$value->student_id}}" target="_blank" title="Character-Certificate" class=" btn btn-danger">
                                                                <i class="fa fa-download "></i>CC</a>

                                                            <a target="_blank" title="Transfer-Certificate" href="{{ url('generate-TC', $value['student_id']) }}"  class=" btn btn-danger" ><i class="fa fa-download"></i>TC</a>
